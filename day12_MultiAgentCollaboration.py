    ...
    prompt = ChatPromptTemplate.from_messages(
        [ #在提示词里体现是什么样的agent/系统提示词
            (
                ...
                " 如果你或其他助手有最终答案或交付物，"
                " 在你的回答前加上FINAL ANSWER，以便团队知道停止。" #终止条件
...
# 创建Python REPL实例
repl = PythonREPL()
# 画图代码是动态的——让大模型生成了代码draw_chart.py然后再跑
